      ...
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto p-6">
        ...
        <div className="grid gap-12 py-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 p-8 border-2 border-gray-300 rounded-lg bg-white shadow-xl">
            <div className="space-y-8">
              <div className="grid grid-cols-4 items-center gap-6">
                <Label
                  htmlFor="title"
                  className="text-right font-semibold text-gray-800 text-lg"
                >
              ...
              <div className="grid grid-cols-4 items-start gap-6">
                <Label
                  htmlFor="description"
                  className="text-right font-semibold pt-3 text-gray-800 text-lg"
                >
                  Mô tả
                </Label>
                <Textarea
          ...
          <div className="col-span-full p-10 border-2 border-dashed border-blue-300 rounded-lg bg-blue-50 shadow-xl">
            <h3 className="text-3xl font-extrabold mb-10 text-blue-800 text-center">
              Tài nguyên bài học{" "}
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              <div className="space-y-5 text-center">
                <Label
                  htmlFor="videoUrl"
                  className="font-bold block text-blue-700 text-xl"
                >
                  Video bài học{" "}
                </Label>
                <VideoUpload
          ...
          <div className="col-span-full p-10 border-2 border-dashed border-green-300 rounded-lg bg-green-50 shadow-xl">
            <h3 className="text-3xl font-extrabold mb-10 text-green-800 text-center">
              Nội dung bài học{" "}
            </h3>
            {formData.content.map((section, index) => (
              <div
                key={index}
                className="grid grid-cols-4 items-start gap-8 mb-10 pb-10 border-b-2 border-green-300 last:border-b-0 last:pb-0"
              >
                <Label
                  htmlFor={`content-title-${index}`}
                  className="text-right font-semibold pt-3 text-green-700 text-lg"
                >
            ...
            <Button
              ...
              className="mt-10 w-full bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-6 rounded-lg text-xl"
            >
        ...
        <DialogFooter className="mt-12 p-6 border-t border-gray-200">
          <Button
            ...
            className="w-full text-2xl py-5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg shadow-lg"
          >
            Tạo bài học
          </Button>
        </DialogFooter>
