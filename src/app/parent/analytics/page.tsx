    ...
    >
      <motion.div variants={itemVariants} className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">Track your children's learning progress and performance</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="border-none shadow-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-sm font-medium">Total Learning Time</p>
                  <p className="text-3xl font-bold">{selectedChild.stats.totalTime}h</p>
                  <p className="text-blue-100 text-sm mt-1">+2.5h from last week</p>
                </div>
          ...
          <Card className="border-none shadow-lg bg-gradient-to-r from-green-500 to-green-600 text-white">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-green-100 text-sm font-medium">Completed Lessons</p>
                  <p className="text-3xl font-bold">{selectedChild.stats.completedLessons}</p>
                  <p className="text-green-100 text-sm mt-1">+5 from last week</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">{selectedChild.stats.averageScore}%</p>
                  <p className="text-purple-100 text-sm mt-1">+3% from last week</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">{selectedChild.stats.achievements}</p>
                  <p className="text-orange-100 text-sm mt-1">+2 from last week</p>
                </div>
        ...
        <Tabs defaultValue="overview" className="w-full">
            ...
            <Card className="border-none shadow-lg">
              ...
              <CardContent>
                <div className="space-y-6">
                  {subjects.map((subject) => (
                    <div key={subject.name} className="p-4 bg-gray-50 rounded-xl">
                      <div className="flex justify-between items-start mb-3">
                        <div className="flex items-center gap-3">
                          <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${subject.bgColor}`}>
                            {subject.icon}
                          </div>
                          <div>
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-sm text-gray-600">{subject.score}% mastery</span>
                            </div>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="font-bold text-lg text-gray-900">{subject.completed}/{subject.total}</p>
                          <p className="text-sm text-gray-600">lessons completed</p>
                        </div>
                      </div>
                      <div className="relative">
                        <Progress value={(subject.completed / subject.total) * 100} className="h-3 bg-gray-200" />
                      </div>
          ...
          <TabsContent value="time">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="border-none shadow-lg">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <CardTitle className="text-lg font-medium">Daily Learning Time</CardTitle>
                  <Calendar className="h-4 w-4 text-gray-500" />
                </CardHeader>
                <CardContent className="pt-4">
                  <div className="h-[300px] flex items-center justify-center">
                    <p className="text-gray-500">Daily time chart would go here</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-none shadow-lg">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <CardTitle className="text-lg font-medium">Time Distribution by Subject</CardTitle>
                  ...
                  <div className="space-y-4">
                    {subjects.map((subject) => (
                      <div key={subject.name} className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${subject.bgColor}`}>
                            {subject.icon}
                          </div>
                          <span className="font-medium">{subject.name}</span>
                        </div>
              ...
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {achievements.map((achievement) => (
                    <div key={achievement.name} className="bg-white border rounded-xl p-4 text-center">
