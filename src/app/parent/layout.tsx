        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64 p-2 shadow-lg border-0 bg-white/95 backdrop-blur-sm">
                <DropdownMenuLabel className="font-normal p-3 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg mb-2">
                  <div className="flex items-center space-x-3">
                    <Avatar className="h-12 w-12 border-2 border-purple-200">
                      <AvatarImage 
                        src={displayAvatar || "/placeholder.svg?height=48&width=48"} 
                        alt="User Avatar"
                        className="object-cover"
                      />
                ...
                <DropdownMenuItem asChild className="cursor-pointer hover:bg-purple-50 rounded-md p-3 transition-colors">
                ...
                >
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-red-400">Thoát khỏi tài khoản</span>
                  </div>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
